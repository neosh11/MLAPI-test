...
//using Pinwheel.Poseidon.TextureGraph;
//#endif
...
namespace Pinwheel.Poseidon
{
    ...
    public class PWater : MonoBehaviour
    {
        ...
        [SerializeField]
        private float manualTimeSeconds;
...
//#if TEXTURE_GRAPH
//        [SerializeField]
//        private TGraph textureGraphAsset;
//        public TGraph TextureGraphAsset
//        {
//            get
//            {
//                return textureGraphAsset;
//            }
//            set
//            {
//                textureGraphAsset = value;
//            }
//        }

//        [SerializeField]
//        private bool useEmbeddedWaveMask;
//        public bool UseEmbeddedWaveMask
//        {
//            get
//            {
//                return useEmbeddedWaveMask;
//            }
//            set
//            {
//                useEmbeddedWaveMask = value;
//            }
//        }

//        [SerializeField]
//        private Texture2D embeddedWaveMask;
//        public Texture2D EmbeddedWaveMask
//        {
//            get
//            {
//                return embeddedWaveMask;
//            }
//            private set
//            {
//                embeddedWaveMask = value;
//            }
//        }
//#endif
        ...
        {
            Shader.SetGlobalFloat(PMat.TIME, GetTimeParam());
            Shader.SetGlobalFloat(PMat.SINE_TIME, Mathf.Sin(GetTimeParam()));
        }
        ...
        private void RenderTiledMesh(Camera cam)
        {
            ...
            PMat.SetFloat(PMat.TIME, GetTimeParam());
            PMat.SetFloat(PMat.SINE_TIME, Mathf.Sin(GetTimeParam()));
            PMat.SetKeywordEnable(PMat.KW_WAVE_MASK, UseWaveMask);
//#if TEXTURE_GRAPH
//            PMat.SetTexture(PMat.WAVE_MASK, UseEmbeddedWaveMask ? EmbeddedWaveMask : WaveMask);
//#else
...
//#endif
        ...
        public float GetTimeParam()
        {
            ...
            {
                float elapsedSeconds = timer.ElapsedMilliseconds * 0.001f;
                float delta = elapsedSeconds - lastElapsedSeconds;
