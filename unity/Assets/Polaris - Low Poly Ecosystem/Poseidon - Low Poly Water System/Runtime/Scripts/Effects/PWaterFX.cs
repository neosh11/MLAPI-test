    ...
    public class PWaterFX : MonoBehaviour
    {
        ...
        private void OnCameraPreCull(Camera cam)
        {
            ...
            if (cam == Camera.main && Water != null)
            {
                ...
                float distanceToSuface = cam.transform.position.y - water.transform.position.y;
                ...
                lastDistanceToSurface = cameraPos.y - water.transform.position.y;
            }
        }
        ...
        private void UpdateEffects(Camera cam)
        {
            ...
            {
                float intensity = cam.transform.position.y < water.transform.position.y ? 1 : 0;
                UpdateUnderwaterIntensityAndWaterLevel(intensity, water.transform.position.y);
            }

            float distanceToSurface = Camera.main.transform.position.y - water.transform.position.y;
